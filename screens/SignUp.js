...
import Icon from 'react-native-vector-icons/Ionicons';
    ...
    const SignUp =  ( { navigation } ) => (
        ...
        <Button color='#fff' title="Register" onPress={() => navigation.navigate('Profile')}/>
         </TouchableOpacity>
                 ...
                 <View style={styles.signuptextcont}>
                   ...
                   <Button color='#161817' fontWeight='bold' title="Sign In" onPress={() => navigation.navigate('Login')}/>
